...
export const metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: "http://localhost:3000/_next/image?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1610576661792-72db77be0900%3Fq%3D80%26w%3D1740%26auto%3Dformat%26fit%3Dcrop%26ixlib%3Drb-4.0.3%26ixid%3DM3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%253D%253D&w=1080&q=75",
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        description:
            "Full Stack Developer, hem frontend hem de backend geliştirme süreçlerine hakim olan kişidir. Yazılım dünyasında bu alanda uzmanlaşmak için detaylı rehberimize göz atın.",
        images: ["http://localhost:3000/_next/image?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1610576661792-72db77be0900%3Fq%3D80%26w%3D1740%26auto%3Dformat%26fit%3Dcrop%26ixlib%3Drb-4.0.3%26ixid%3DM3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%253D%253D&w=1080&q=75"],
        site: "@GoktayGurbuzer",
    },
};
                                            ...
                                            <div className="col-lg-8 offset-lg-2">
                                                ...
                                                <div className="blog-item mb-80 mb-xs-40">
                                                    <div className="blog-item-body">
                                                        <p className="lead">
                                                            Full Stack Developer, yazılım geliştirme dünyasında hem ön
                                                        ...
                                                        <p>Hem frontend hem de backend alanlarında bilgi sahibi olan ve
                                                            ...
                                                            yeterlilikteki kişidir. Bir full stack developer, hem
                                                        ...
                                                        <h2>Full Stack Developer Olmak için Neleri Bilmek
                                                            Gerekiyor?</h2>
                                                        <p>Full stack developer olmak, yazılım dünyasında oldukça geniş
                                                        ...
                                                        <p>Full stack developer olmak, bu alanlarda bilgilenmek için
                                                        ...
                                                        <p>Full stack developer olmak için belirli bir öğrenim yolunu
                                                        ...
                                                        <p>Öncelikle HTML, CSS ve JavaScript ile başlayarak web
                                                            ...
                                                            her full stack developer'ın bilmesi gereken temel
                                                            taşlardır.</p>
                                                        ...
                                                        <p>Bir full stack developer, frontend ve backend’i birleştirebilmelidir. Örneğin, bir kullanıcı girişi sistemi veya e-ticaret uygulaması yaparak hem frontend hem de backend becerilerinizi geliştirebilirsiniz.</p>
                                                        ...
                                                        <p>Full stack developer'lar, birçok yetkinliğe sahip oldukları için hem frontend hem de backend projelerinde iş bulabilirler.</p>
                                                        ...
                                                        <h3>Yüksek Maaş:</h3>
                                                        <p>Full stack developer'lar, geniş bilgi birikimleri nedeniyle genelde daha yüksek maaş alırlar.</p>

                                                        <h2>Full Stack Developer Olduktan Sonra Ne Olacak?</h2>
                                                        <p>Full stack developer olduktan sonra birçok kapı önünüzde açılır. İşte bu meslekte elde edeceğiniz kazanımlar:</p>
                                                        <ul>
                                                        ...
                                                        <h3>Sonuç</h3>
                                                        <p>Full stack developer olmak, yazılım dünyasına hakim olmak isteyen herkes için harika bir hedeftir. Hem frontend hem de backend geliştirme bilgisi sayesinde projelere bütünsel bir bakış açısıyla yaklaşabilirsiniz. Bu yolculuk boyunca öğrenmeyi sürdürmek, pratik yapmak ve disiplinli olmak başarıya ulaşmanız için en önemli adımlardır.</p>
