export const stepsData = [
  {
    number: "1",
    title: "Araştırıyorum ",
    text: "İhtiyaçlarınızı anlamak için derinlemesine araştırma yapıyorum. Bu süreçte hedef kitlenizi ve projede yer alacak temel unsurları belirliyorum.",
  },
  {
    number: "2",
    title: "Tasarlıyorum",
    text: "Modern ve kullanıcı dostu bir deneyim sunmak için estetik ve işlevsel tasarımlar oluşturuyorum. Her ayrıntı dikkatle ele alınır.",
  },
  {
    number: "3",
    title: "Geliştiriyorum",
    text: "Projeyi planlara uygun şekilde kodluyor ve performans odaklı çözümler üretiyorum. Tüm süreçte modern teknolojiler kullanıyorum.",
  },
  {
    number: "4",
    title: "Yayınlıyorum",
    text: "Projenizi yayına alırken tüm teknik optimizasyonları ve testleri tamamlıyorum. Yayın sonrası destekle projeyi güçlendirmeye devam ediyorum.",
  },
];
